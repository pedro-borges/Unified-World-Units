...
class LitresTest
{
    ...
    fun sphereFactory()
    {
        assertEquals("0.00418879020478639 l",
                     Litres.FOR.sphere(Meters(10, MILLI), DECIMAL64).toString())
        assertEquals("4.18879020478639 l",
                     Litres.FOR.sphere(Meters(10, CENTI), DECIMAL64).toString())
        assertEquals("4188.79020478639 l",
                     Litres.FOR.sphere(Meters(10, DECI), DECIMAL64).toString())
    }
    ...
    fun cubeFactory()
    {
        assertEquals("0.001 l",
                     Litres.FOR.cube(Meters(1, CENTI), DECIMAL64).toString())
        assertEquals("1 l",
                     Litres.FOR.cube(Meters(1, DECI), DECIMAL64).toString())
        assertEquals("1000 l",
                     Litres.FOR.cube(Meters(1), DECIMAL64).toString())
    }
}
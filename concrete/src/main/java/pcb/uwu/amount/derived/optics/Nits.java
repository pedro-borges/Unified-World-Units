...
public class Nits extends Luminance {
	...
	@NotNull
	@Override
	public Nits times(@NotNull Number other) {
		return new Nits(UnitAmountUtils.times(this, other));
	}

	@NotNull
	@Override
	public Nits div(@NotNull Number other) {
		return new Nits(dividedByScalar(this, other));
	}

...
open class ElectricCapacitance : CompositeUnitAmount<ElectricCapacitanceUnit>
{
    ...
    override fun plus(amount: UnitAmount<ElectricCapacitanceUnit>) =
        ElectricCapacitance(amount = this.amount + (amount to this.unit).amount,
                            unit = this.unit)

    override fun minus(amount: UnitAmount<ElectricCapacitanceUnit>) =
        ElectricCapacitance(amount = this.amount - (amount to this.unit).amount,
                            unit = this.unit)

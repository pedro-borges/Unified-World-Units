...
public class TimeUnit extends BaseUnit<TimeUnit> {
	...
	public static final TimeUnit WEEK = new TimeUnit(
			"wk", "week", "weeks",
			value -> value.multiply(SECONDS_PER_WEEK, DECIMAL64),
			value -> value.divide(SECONDS_PER_WEEK, DECIMAL64));
	...
	private TimeUnit(String symbol,
					 String singularName,
					 String pluralName, Function<BigDecimal, BigDecimal> translationToCanonical,

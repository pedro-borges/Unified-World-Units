...
public class AbstractUnitAmountTest {
	...
	public void getValueIn() {
		assertEquals(new BigDecimalAmount("0.0254"), METER.getAmountIn(new InchUnit()));
		assertEquals(new BigDecimalAmount("0.0254").pow(-1, DECIMAL64), INCH.getAmountIn(new MeterUnit()));
	}
}